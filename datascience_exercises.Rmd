...
First, ensure the delimiter is set correctly so you can play with 
...
Use the function `read_excel` to read the additional observations in data file `` (an Excel file!), also located in your `data` folder, into R.
