...
```{r}
penguins <- read_delim("data/penguins.tsv")
```
...
# penguins_subset <- filter(penguins, (Sex == "FEMALE" | Sex == "MALE"))
...
```{r}
penguins_subset_2 <- select(penguins_subset, Individual_ID, Species,Sex, Island, Culmen_Depth_mm, Culmen_Length_mm)

#penguins_subset_2 <- select(penguins_subset, Individual_ID, Species,Sex, Island, starts_with("Culmen"))
 
#penguins_subset_2 <- select(penguins_subset, Individual_ID, Species,Sex, Island, contains("Culmen"))
```
...
penguins_subset_5 <- penguins_subset_4 %>%
  rename(length = Culmen_Length_mm, depth = Culmen_Depth_mm)
```
