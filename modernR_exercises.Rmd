...
In this exercise, we read the dataset `Huji_JNF_Crane_israel_GPRS.csv` into the 
...
*Tip: The file location (argument `file`) should be 'data/Huji_JNF_Crane_israel_GPRS.csv'* 
...
Read the additional observations in data file `Huji_JNF_additional_observations.xlsx` (Excel file!). Complete the code in the
code cell below.
...
read_csv('data/Huji_JNF_Crane_israel_GPRS.csv',
  col_types = cols(
    . = col_guess(),
